export const YASAM_STANDARTLARI = {
  yemek: {
    ...
    secenekler: [
      ...
      { id: "yuksek", label: "Sağlıklı / sık dışarıda", aylik_usd: 45, mutluluk_etki: 2, sabir_etki: 1 },
    ]
  },
  ulasim: {
    label: "Ulaşım",
    ...
    secenekler: [
      ...
      { id: "yuksek", label: "Sıfır araç", aylik_usd: 80, mutluluk_etki: 2, sabir_etki: 1 },
    ]
  },
  konut: {
    label: "Konut",
    ...
    secenekler: [
      ...
      { id: "yuksek", label: "Büyük kira", aylik_usd: 200, mutluluk_etki: 2, sabir_etki: 1 },
  ...
  saglik: {
    ...
    secenekler: [
      ...
      { id: "yuksek", label: "Tam özel", aylik_usd: 35, mutluluk_etki: 2, sabir_etki: 1 },
    ]
  },
}
